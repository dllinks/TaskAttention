...
def parse_arguments():
    ...
    if("vikrant" in host_name):
        ...
        EXP_DIR  = "/home/aroof/paramshivay/scratch/TaskAttention/exp/{}/{}/{}_F/{}WAY_{}SHOT/{}/Attention-{}".format(config.user,config.dataset,config.n_filters,config.n_class,config.n_shot,config.algo,config.task_attention)
